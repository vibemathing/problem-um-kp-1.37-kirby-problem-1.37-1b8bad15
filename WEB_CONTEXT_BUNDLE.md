...
```json
{
  ...
  "attempts": [
    {
      "artifacts": [],
      "attempt_id": "attempt:um-kp-1.37-kirby-problem-1.37-1b8bad15-source-fidelity-01",
      "claims": [],
      "completed_at": null,
      "generator": "trusted-rolling-source-admission-v1",
      "inputs": [
        "problem-library/records/canonical-problems.jsonl",
        "https://www.unsolvedmath.com/problems/KP-1.37"
      ],
      "lifecycle": "planned",
      "method": "discovery",
      "objective": "Close the source-fidelity obligation before attempting the frozen root statement.",
      "obligation_graph_id": "graph:um-kp-1.37-kirby-problem-1.37-1b8bad15-v1",
      "problem_contract_sha256": "bb21e3445a8982ab2a0ef0c96b20252e533ca5e1272c63acb25a8837a2e00d35",
      "problem_id": "problem:um-kp-1.37-kirby-problem-1.37-1b8bad15",
      "route_id": "route:um-kp-1.37-kirby-problem-1.37-1b8bad15-source-fidelity",
  ...
  "obligation_graphs": [
    {
      "attempt_id": "attempt:um-kp-1.37-kirby-problem-1.37-1b8bad15-source-fidelity-01",
      "graph_id": "graph:um-kp-1.37-kirby-problem-1.37-1b8bad15-v1",
      "obligations": [
        {
          "dependencies": [
            "obligation:um-kp-1.37-kirby-problem-1.37-1b8bad15-statement-fidelity"
          ],
          "kind": "root_claim",
          "obligation_id": "obligation:um-kp-1.37-kirby-problem-1.37-1b8bad15-root",
          "statement": {
            "formal_declaration": null,
            "language": "en",
            "text": "(a) For every link $L \\subset \\mathbb{R}^{3}$, every simple Lie algebra $\\mathfrak{g}$, and every coloring of the components of $L$ with irreducible representations of $\\mathfrak{g}$, construct a bigraded link homology theory that is functorial under link cobordisms, and whose Euler characteristic is the Reshetikhin–Turaev link invariant associated to $\\mathfrak{g}$ and $L$. (b) For each of the theories above, define an odd version $($ with the same mod 2 reduction $)$ or explain the obstruction to its existence."
          },
          "statement_sha256": "83046051497239834fd373e73352d89cf25ea3d22c3eb1d1e7fcb2a6388fe656"
        },
        {
          "dependencies": [],
          "kind": "definition",
          "obligation_id": "obligation:um-kp-1.37-kirby-problem-1.37-1b8bad15-statement-fidelity",
          "statement": {
            "formal_declaration": null,
            "language": "en",
      ...
      "root_obligation_id": "obligation:um-kp-1.37-kirby-problem-1.37-1b8bad15-root",
      "route_id": "route:um-kp-1.37-kirby-problem-1.37-1b8bad15-source-fidelity"
    }
  ],
  "problem_contract": {
    ...
    "sources": [
      {
        ...
        "source_record_id": "unsolvedmath-kp-1.37-9d09396ca2ac",
        "url": "https://www.unsolvedmath.com/problems/KP-1.37"
      },
      {
        "retrieved_at": "2026-09-02T00:06:43Z",
